                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-cat text-center mb-30">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">We provide you with information about the daily food
                                        system.</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-cat text-center mb-30">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">We provide you with some information to help prevent high
                                        blood pressure.</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="home-blog-single mb-40">
                            <div class="blog-img-cap">
                                ...
                                <div class="blog-cap">
                                    <h3><a href="foodtable.php">"Let us protect ourselves from high Blood pressure."</a>
                                    </h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="home-blog-single mb-40">
                            <div class="blog-img-cap">
                                ...
                                <div class="blog-cap">
                                    <h3><a href="blog_details.html">"Let us protect ourselves from high Blood
                                            Sugar."</a></h3>
