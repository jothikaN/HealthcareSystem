        ...
        <?php while ($patient = $result->fetch_assoc()): ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="process_patient_delete.php?id=<?php echo $patient['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this patient?');">Delete</a>
                    <!-- Send Email button (calls send_email_to_patient.php with the patient id) -->
                    <a href="send_email_to_patient.php?id=<?php echo $patient['id']; ?>" class="btn btn-info btn-sm">Send Email</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
